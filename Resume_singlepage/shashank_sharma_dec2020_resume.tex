...
\resumeItemListStart
\resumeItem{Developing a robust SLAM algorithm testing pipeline using ROS, Gazebo and Rviz.}
\resumeItem{Creating Occupancy Grids for 2D and 3D Lidar sensors using Gmapping, Octomap and Cartographer.}
