...
\resumeSection{Experience}
    ...
    \resumeItem{Generated concepts for a mechanism which adjusts the interpupillary distance between the lenses focusing on manufacturability and robustness.}
    \resumeItemListEnd
    ...
    \resumeItemListStart
    \resumeItem{Designed and manufactured Hydro-kinetic turbine with improved airfoil design which produce 50\% more power in collaboration with Leviathan Energy.}
